...
const Portfolio = () => {
  const personalInfo = {
    name: "Mohammed Web Developer",
    title: "MERN STACK Developer",
    about:
      "I am a Fullstack Web Developer specializing in ReactJS on the frontend and Node.js/Express.js with MongoDB on the backend. I enjoy transforming ideas into user-friendly applications that solve real-world problems. I focus on building responsive, interactive, and accessible interfaces using React, TailwindCSS, and modern state management tools like Context API. On the backend, I design secure and efficient RESTful APIs with Node.js, Express.js, and MongoDB, implementing features such as authentication, CRUD operations, and data validation",
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Built a responsive product page website with a product list page, product details page and a cart list page, and complex state management using react context.",
      technologies: ["React", "Tailwind CSS"],
      features: [
        "Custom hooks",
        "Context API",
    ...
    },
    {
      ...
      description:
        "Built a responsive and user-friendly web application designed to help users discover recipes based on cuisine choices and dietary preferences",
    ...
    },
    {
      ...
      description:
        "Developed a habit tracker application, where users can add, remove and track their daily habits by marking them as completed.",
    ...
    },
    {
      title: "Weather App",
      description:
        "Created a weather app displaying weather conditions of searched cities.",
      technologies: ["React", "Tailwind CSS"],
    ...
    },
    {
      title: "Blog Editor",
      description:
        "Developed a blog editor application, where users can add, remove and edit already added blogs to the blog list",
      technologies: ["React", "React Redux", "Tailwind CSS"],
    ...
    },
    {
      title: "Tenzies Game",
      description:
        "Developed a tenzies game, where users can roll dices multiple times to obtian the same number on all dice, and a counter for keeping track of the number of rolls needed to win",
      technologies: ["React", "Tailwind CSS"],
  ...
  const backendProjects = [
    ...
    },
    {
      ...
      description:
        "Developed a backend service that enables users to track incomes, expenses, and calculate remaining balance, and utilizing Express.js and MongoDB to manage user accounts, financial entries, and categorized transactions.",
      technologies: ["NodeJS", "ExpressJS", "MongoDB"],
      github: "https://github.com/mohammedZato/Expense-Tracker",
    },
    {
      title: "Blog API",
      description:
        "Designed and implemented a complete blog management API using Node.js, Express.js, and MongoDB, added features including user registration and login with JWT authentication, error handling middleware, and CRUD functionality for blog posts.",
      technologies: ["NodeJS", "ExpressJS", "MongoDB"],
      github: "https://github.com/mohammedZato/Blog_API_Dev",
    },
  ];
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a
              href="https://github.com/mohammedZato"
              target="_blank"
              className="flex items-center gap-2 text-gray-600 hover:text-gray-900"
            >
            ...
            <a
              href="https://www.linkedin.com/in/mohammed-haruna-231-zato/"
              target="_blank"
              className="flex items-center gap-2 text-gray-600 hover:text-gray-900"
            >
